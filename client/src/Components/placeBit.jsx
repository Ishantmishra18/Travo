...
const PlaceBit = ({ post, show }) => {
  ...
  return (
  <div className="w-full max-w-2xl mx-auto p-6 sm:p-8 md:p-10 rounded-3xl shadow-xl bg-white space-y-8 border border-gray-100">
    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center">Make a Bid</h2>
    ...
    <div className="pt-4 sm:pt-6 flex justify-end">
      <button
        onClick={handleBit}
        className="bg-black text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full hover:bg-gray-800 text-sm font-semibold transition w-full sm:w-auto"
      >
        Submit Bid
      </button>
    </div>
